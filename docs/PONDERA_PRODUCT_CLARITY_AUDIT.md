...
- `Pondera/Pondera/App/AppRouter.swift`
...
- `Pondera/Pondera/Audio/CheckInRecorderService.swift`
  - Short recording capture.
- `Pondera/Pondera/Audio/TranscriptionWorker.swift`
  - Apple Speech transcription used by the recording flows.
- `Pondera/Pondera/UI/CheckIns/CheckInDetailView.swift`
  - Displays timestamp, transcript, persisted progress entries, optional mood, evidence, and cumulative percentages.
- `Pondera/Pondera/UI/CheckIns/CheckInsListView.swift`
  - Lists saved Check-Ins.
- `Pondera/Pondera/UI/Home/AmbiguityDisambiguationSheet.swift`
...
- `Pondera/Pondera/Audio/TranscriptionQueue.swift` and `TranscriptionWorker.swift`
  - Queue and persist segment transcription.
- `Pondera/Pondera/Understanding/ExtractionQueue.swift`
  - Runs extraction after persisted transcription and coordinates completion.
- `Pondera/Pondera/Understanding/ExtractorService.swift`
